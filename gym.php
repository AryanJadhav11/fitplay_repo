...
<body>
  ...
  <div class="intro">
    <div class="text-container">
      <b>
        <p style="font-size: 60px; color: white;">Welcome to FitPlay-Gyms!</p>
      </b>
      <h4 style="color: white;">The only place you need to discover, compare, <br>and choose the perfect gym for your fitness journey!</h4>
    </div>
  </div>
  <!-- HERO END -->
  <main id="main">
    ...
    <div class="slogan">
      ...
      <b><i>
          <p class="slogan-content">HARDER. BETTER. FASTER. STRONGER.</p>
        </i></b>

    </div>
    <div class="gymlist container">

    </div>
    <!-- gym list -->
    <div class="container">
      <div class="col-lg-12 explpore-gyms" ><h1 style="font-family: 'Rowdies', sans-serif;">Explore Gyms</h1></div>
