  ...
  <section class="pt-5   pb-0">
        ...
        <aside class="col-lg-6 py-0">
          <div class="border rounded-4 mb-3 d-flex justify-content-center"
            ...
            <img id="mainImage" style="width: 100%; height: 100%; margin: auto;" class="rounded-4 img-fluid fit"
              src="./GYm/assets/img/ruglogo.jpeg" alt="Main Image" />
            <!-- Previous Button -->
          ...
          <div class="d-flex justify-content-center mb-3">
            <!-- Thumbnail Links -->
            <a onclick="changeMainImage('./GYm/assets/img/ruglogo.jpeg'); return false;">
              <img width="60" height="50" class="rounded-2" src="./GYm/assets/img/ruglogo.jpeg" alt="Thumbnail 1" />
            </a>
            <a onclick="changeMainImage('./GYm/assets/img/rug1.jpeg'); return false;">
              <img width="60" height="50" class="rounded-2" src="./GYm/assets/img/rug1.jpeg" alt="Thumbnail 2" />
            </a>
            <a onclick="changeMainImage('./GYm/assets/img/rug2.jpeg'); return false;">
              <img width="60" height="50" class="rounded-2" src="./GYm/assets/img/rug2.jpeg" alt="Thumbnail 2" />
            </a>
            <a onclick="changeMainImage('./GYm/assets/img/rug3.jpg'); return false;">
              <img width="60" height="50" class="rounded-2" src="./GYm/assets/img/rug3.jpg" alt="Thumbnail 2" />
            </a>
            <a onclick="changeMainImage('./GYm/assets/img/rug5.jpg'); return false;">
              <img width="60" height="50" class="rounded-2" src="./GYm/assets/img/rug5.jpg" alt="Thumbnail 2" />
            </a>
          </div>
          <style>
    ...
    .scrollable-div {
        ...
        <script>
          ...
          var images = ['./GYm/assets/img/ruglogo.jpeg', './GYm/assets/img/rug1.jpeg', './GYm/assets/img/rug2.jpeg', './GYm/assets/img/rug3.jpg', './GYm/assets/img/rug5.jpg'];
        ...
        <main class="col-lg-6">
          <div class="ps-lg-3">
            <div>
              <div class="gymname">
                <h2 class="title ">
                  <b>RUGGEDIAN FITNESS MULTIPLEX</b>
                </h2>
            ...
            <div class="gymdese">
              ...
              RUGGEDIAN FITNESS MULTIPLEX. City's biggest fitness hub with personalised group batches ,certified staff and various zones.Kolhapur's Largest Fitness Hub with over 25000
sq area, indoor and outdoors included.
Pay Per Workout via our mobile applicaon that
counts your visits so we charge you only for the
days that you work out.
Personalized Group Batches that are carefully
craed to fit your needs with experts in the field
available for sessions that you choose.
WE ARE OPEN 24 HOURS A DAY, 7 DAYS A WEEK,
365 DAYS A YEAR because fitness should not be
limited to me.
              </p>
            </div>
          ...
          <div class="container">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15286.132710040703!2d74.23307640163958!3d16.700227882057998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc101a302df81c7%3A0x8a23e3bc0e0670aa!2sRuggedian%20Fitness%20Multiplex!5e0!3m2!1sen!2sin!4v1710784482356!5m2!1sen!2sin" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </main>
      </div>
    </div>
            ...
            <div class="packs pt-5">
              ...
              <div class="card text-center mb-3" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <p class="card-text" style="color:white;">6000/3 Mo</p>
              ...
              <div class="card text-center mb-3" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <p class="card-text" style="color:white;">11,000/6 Mo</p>
...
try {
    ...
    $mail->addAddress('info@ruggedian.in', 'RUGGEDIAN FITNESS MULTIPLEX');     //Add a recipient info@ruggedian.in
...
// Email Body
$body = '<p>Dear RUGGEDIAN FITNESS MULTIPLEX,</p>';
