...
session_start();
$id=$_GET['editid'];
$sql6="SELECT * FROM `grd`  WHERE id='$id'";
$que6=mysqli_query($con,$sql6);
$res6=mysqli_fetch_assoc($que6);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sizee=$_FILES['image']['size'];
    $destinatione="upload/".$filenamee;
    if($sizee<=20000000)
    {
    ...
    <p>Turf details have been updated successfully</p>
    <hr>
