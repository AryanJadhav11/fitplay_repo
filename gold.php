                ...
                <div class="row">
                  <div class="col-sm-3 col-md-3 pricing-column-wrapper card">
                    <div class="pricing-column">
                      <div class="pricing-price-row">
                        <div class="pricing-price-wrapper">
                          <div class="pricing-price">
                            <div class="pricing-cost">5000₹</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <figure class="pricing-row">Zumba, Yoga, MMA, etc</figure>
                  ...
                  <div class="col-sm-3 col-md-3 pricing-column-wrapper card">
                    <div class="pricing-column">
                      <div class="pricing-price-row">
                        <div class="pricing-price-wrapper">
                          <div class="pricing-price">
                            <div class="pricing-cost">8,000₹</div>
                          </div>
                        </div>
                      </div>
                      <div class="pricing-row-title">
                  ...
                  <div class="col-sm-3 col-md-3 pricing-column-wrapper card">
                    <div class="pricing-column">
                      <div class="pricing-price-row">
                        <div class="pricing-price-wrapper">
                          <div class="pricing-price">
                            <div class="pricing-cost">15,000₹</div>
                          </div>
                        </div>
                      </div>
                      <div class="pricing-row-title">
...
try {
    ...
    $mail->addAddress('tarabaipark.kolhapur@goldsgym.in', 'GOLDS GYM');     //Add a recipient tarabaipark.kolhapur@goldsgym.in
